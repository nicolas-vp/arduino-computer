...
| **Динамик**         | Подключён к пину 8                                                       |
| **LED-индикаторы**  | Пин 10 (мигает при операциях с EEPROM), 11, 12, 13 (мигает при загрузке) |
...
Нажмите `FN+Пробел` в редакторе или в режиме ввода BASIC. В правом верхнем углу на 1 секунду появится индикатор текущей раскладки:
...
[Игра угадай число](doc/examples/guess.md)